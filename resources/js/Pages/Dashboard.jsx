...
const AdminDashboard = ({ stats: initialStats }) => {
        ...
        const fetchStats = async () => {
            ...
            try {
                const endpoint = selectedTeacher === 'all' 
                    ? '/api/dashboard/stats' 
                    : `/api/dashboard/stats/teacher/${selectedTeacher}`;
    ...
    useEffect(() => {
        ...
        // Listen for localStorage changes (for same-device cross-tab communication)
        const handleClassUpdate = (event) => {
            if (event.key === 'class_updated' && event.newValue) {
                console.log('Admin Dashboard detected class update from localStorage');
        ...
        // Server-side polling for cross-device updates
        const checkForUpdates = async () => {
            try {
                const response = await axios.get(`/api/class-updates/last?since=${lastCheckTime}`);
                if (response.data.has_updates) {
                    console.log('Admin Dashboard detected server-side class update, refreshing stats...');
                    refreshStats();
                    lastCheckTime = response.data.last_update;
                }
            } catch (error) {
        ...
        const serverPollingInterval = setInterval(checkForUpdates, 5000);
                                ...
                                <div className="bg-gradient-to-br from-green-50 to-emerald-50 p-4 rounded-xl border border-green-100">
                                    <div className="flex items-center justify-between">
                                        ...
                                        <div className="text-2xl font-bold text-green-600">
                                            {loading ? '...' : (stats.monthlyCompleted || 0)}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="bg-gradient-to-br from-orange-50 to-amber-50 p-4 rounded-xl border border-orange-100">
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center">
                                            ...
                                            <span className="text-sm font-semibold text-slate-800">Absent w/ Notice (Counted)</span>
                                        </div>
                                        <div className="text-2xl font-bold text-orange-600">
                                            {loading ? '...' : (stats.monthlyWithNotice || 0)}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="bg-gradient-to-br from-slate-50 to-gray-50 p-4 rounded-xl border border-slate-200">
                                    <div className="flex items-center justify-between">
                                        ...
                                        <div className="text-2xl font-bold text-slate-600">
                                            {loading ? '...' : (stats.monthlyNotCounted || 0)}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="bg-gradient-to-br from-red-50 to-rose-50 p-4 rounded-xl border border-red-100">
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center">
                                            ...
                                            <span className="text-sm font-semibold text-slate-800">Absent (No Notice)</span>
                                        </div>
                                        <div className="text-2xl font-bold text-red-600">
                                            {loading ? '...' : (stats.monthlyAbsent || 0)}
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div className="bg-white/80 p-4 rounded-lg">
                                        <div className="flex items-center justify-between">
                                            ...
                                            <span className="text-xl font-bold text-amber-600">
                                                {loading ? '...' : (stats.monthlyFreeClassNotConsumed || 0)}
                                            </span>
                                        </div>
                                    </div>
                                    <div className="bg-white/80 p-4 rounded-lg">
                                        <div className="flex items-center justify-between">
                                            ...
                                            <span className="text-xl font-bold text-amber-600">
                                                {loading ? '...' : (stats.monthlyFreeClassConsumed || 0)}
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                                    ...
                                    <div className="bg-orange-50 p-4 rounded-lg border border-orange-100">
                                        <div className="text-center">
                                            ...
                                            <span className="text-sm text-slate-600">W/ Notice (Counted)</span>
                                        </div>
                                    </div>
                                    ...
                                    <div className="bg-purple-50 p-4 rounded-lg border border-purple-100">
                                        <div className="text-center">
                                            ...
                                            <span className="text-2xl font-bold text-purple-600 block">
                                                {loading ? '...' : (stats.monthlyCancelled || 0)}
                                            </span>
                                    ...
                                    <div className="bg-gray-50 p-4 rounded-lg border border-gray-100">
                                        <div className="text-center">
                                            ...
                                            <span className="text-2xl font-bold text-gray-600 block">
                                                {loading ? '...' : (stats.monthlyValidForCancellation || 0)}
                                            </span>
                                            <span className="text-sm text-slate-600">Valid for Cancel</span>
                                        </div>
                                    </div>
                                    <div className="bg-amber-50 p-4 rounded-lg border border-amber-100">
                                        <div className="text-center">
                                            ...
                                            <span className="text-sm text-slate-600">FC Not Used</span>
                                        </div>
                                    </div>
                                    <div className="bg-amber-50 p-4 rounded-lg border border-amber-100">
                                        <div className="text-center">
                                            ...
                                            <span className="text-sm text-slate-600">FC Used</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                            ...
                            <div className="grid grid-cols-4 gap-4">
                                ...
                                <div className="p-4 bg-navy-50 rounded-lg text-center hover:bg-navy-100 transition-colors">
                                    <div className="w-3 h-3 rounded-full bg-blue-400 mx-auto mb-2"></div>
                                    <span className="block text-xl font-bold text-navy-900">
                        ...
                        <div className="space-y-4">
                            <div style={{display: 'none'}} className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                            ...
                            <div className="space-y-4">
                                {/* Free Classes card removed from here to avoid duplication */}
                                ...
                                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                                    ...
                                    <div className="flex items-center justify-between">
                                        ...
                                        <span className="text-2xl font-bold text-navy-900">
                                            {loading ? '...' : (stats.teacherAbsences || 0)}
                                        </span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div>
                            ...
                            <div className="text-sm text-navy-700">
                                ...
                                <p className="text-navy-600 flex items-center">
                                    <Calendar className="w-4 h-4 mr-1.5 text-orange-500" />
                                    These statistics show data for the current calendar month. Statistics automatically reset on the first day of each month at 1:00 AM.
                                </p>
                            </div>
                        </div>
                    </div>
...
const TeachersDashboard = ({ stats: initialStats }) => {
    const [stats, setStats] = useState(initialStats || {
        totalStudents: 0,
        totalClasses: 0,
        monthlyCompleted: 0,
        ...
        monthlyNotCounted: 0,
        monthlyCancelled: 0,
        monthlyFreeClassNotConsumed: 0,
        monthlyFreeClassConsumed: 0,
        teacherAbsences: 0,
        todayCompleted: 0,
        todayAbsent: 0,
        todayWithNotice: 0,
    ...
    useEffect(() => {
        const fetchStats = async () => {
            setLoading(true);
            try {
                const response = await window.axios.get(`/api/dashboard/stats/teacher/${auth.user.id}`);
                setStats(response.data);
            } catch (error) {
                console.error('Error fetching stats:', error);
            } finally {
    ...
    // Real-time updates for teacher dashboard stats
    useEffect(() => {
        let lastCheckTime = Math.floor(Date.now() / 1000);
        ...
        const refreshStats = async () => {
            try {
                ...
                console.error('Error refreshing teacher stats:', error);
            }
        };
        ...
        const handleClassUpdate = (event) => {
            if (event.key === 'class_updated' && event.newValue) {
                console.log('Teacher Dashboard detected class update from localStorage');
                setTimeout(refreshStats, 500);
            }
        };
        ...
        const checkForUpdates = async () => {
            try {
                const response = await axios.get(`/api/class-updates/last?since=${lastCheckTime}`);
                if (response.data.has_updates) {
                    console.log('Teacher Dashboard detected server-side class update, refreshing stats...');
                    refreshStats();
                    lastCheckTime = response.data.last_update;
                }
            } catch (error) {
    ...
    return (
        <div className="py-12">
            <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                ...
                <div className="mb-8">
                    <h1 className="text-2xl font-bold text-navy-800">Welcome, {auth.user.name}</h1>
                    <p className="text-navy-600 mt-1">Here's an overview of your teaching statistics</p>
                </div>
                
                {/* Teacher Stats Cards */}
                <div className="grid grid-cols-1 gap-6 md:grid-cols-3 mb-8">
                    <div className="p-6 bg-slate-700 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300">
                        <div className="flex items-center">
                            ...
                            <div className="ml-4">
                                ...
                                <div className="flex items-baseline">
                                    ...
                                    <span className="ml-2 text-xs text-slate-300 font-medium">This month</span>
                                </div>
                            </div>
                        </div>
                    </div>

                    <div className="p-6 bg-emerald-500 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300">
                        <div className="flex items-center">
                            ...
                            <div className="ml-4">
                                ...
                                <div className="flex items-baseline">
                                    ...
                                    <span className="ml-2 text-xs text-emerald-100 font-medium">From cancelled</span>
                                </div>
                            </div>
                        </div>
                    </div>

                    <div className="p-6 bg-purple-500 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300">
                        <div className="flex items-center">
                            ...
                            <div className="ml-4">
                                ...
                                <div className="flex items-baseline">
                                    <p className="text-2xl font-bold text-white">
                                        {loading ? '...' : ((stats.monthlyFreeClassNotConsumed || 0) + (stats.monthlyFreeClassConsumed || 0))}
                                    </p>
                                    <span className="ml-2 text-xs text-purple-100 font-medium">{loading ? '...' : (stats.monthlyFreeClassNotConsumed || 0)} not used</span>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                                    <div className="flex justify-between items-center mb-3">
                                        ...
                                        <div className="text-xs text-green-600 font-medium bg-green-50 px-2 py-1 rounded-full">
                                            {loading ? '...' : ((stats.monthlyFreeClassNotConsumed || 0) + (stats.monthlyFreeClassConsumed || 0))} Total
                                        </div>
                                    </div>
