...
/*
|--------------------------------------------------------------------------
| Real-time Update API Routes  
|--------------------------------------------------------------------------
*/
Route::middleware(['auth', 'verified'])->group(function () {
    Route::get('/class-updates/last', [App\Http\Controllers\Api\ClassUpdateController::class, 'getLastUpdate'])->name('api.class-updates.last');
    Route::post('/class-updates/mark', [App\Http\Controllers\Api\ClassUpdateController::class, 'markUpdate'])->name('api.class-updates.mark');
});
