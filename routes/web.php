...
/*
|--------------------------------------------------------------------------
| Shared API Routes (Admin & Teacher Access)
|--------------------------------------------------------------------------
*/
Route::middleware(['auth', 'verified'])->prefix('api')->group(function () {
    // Dashboard stats routes (accessible to both admin and teacher)
    Route::get('dashboard/stats', [DashboardController::class, 'getStats'])->name('api.dashboard.stats');
    Route::get('dashboard/stats/teacher/{teacherId}', [DashboardController::class, 'getTeacherStats'])->name('api.dashboard.teacher-stats');
    
    // Class update tracking routes (accessible to both admin and teacher)
    Route::get('class-updates/last', [\App\Http\Controllers\ClassUpdateController::class, 'getLastUpdate'])->name('api.class-updates.last');
    Route::post('class-updates/mark', [\App\Http\Controllers\ClassUpdateController::class, 'markUpdate'])->name('api.class-updates.mark');
});
