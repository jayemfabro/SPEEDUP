...
class DashboardController extends Controller
{
    ...
    {
        try {
            // Use the comprehensive getDashboardStats method which includes detailed monthly breakdowns
            if ($teacherId && $teacherId !== 'all') {
                $teacher = User::find($teacherId);
                if ($teacher && $teacher->isTeacher()) {
                    // Get comprehensive stats using the main method
                    $stats = $this->getDashboardStats($teacherId);
                    
                    // Add additional teacher-specific information
                    $teacherName = $teacher->getFullNameAttribute();
                    $teacherImage = $teacher->profile_photo_url;
                    
                    // Add teacher-specific fields to the response
